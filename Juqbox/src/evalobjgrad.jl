...
# Regular arrays
    function objparams(Ne::Array{Int64,1}, Ng::Array{Int64,1}, T::Float64, nsteps::Int64;
        ...
        # t_cvar = zeros(1)
        new(Nosc, N, Nguard, Ne, Ng, Ne+Ng, T, nsteps, Uinit, Utarget, use_bcarrier, Nfreq, Cfreq, kpar, tik0, Hconst, Hsym_ops1, Hanti_ops1, Hunc_ops1, Ncoupled, Nunc, isSymm, Ident, wmat, forb_states,forb_weights,wmat_real,wmat_imag, pFidType, 0.0, saveConvHist, zeros(0), zeros(0), zeros(0), zeros(0), nNeumann, traceInfidelityThreshold, 0.0, 0.0, usingPriorCoeffs, priorCoeffs, quiet, Rfreq, false, [], use_cvar)
    end
...
mutable struct Working_Arrays
    ...
    grad_f_his  ::Array{Float64,2}
    objfv_his   ::Array{Float64,1}
    exp_v       ::Array{Float64,1}
    ...
    function Working_Arrays(params::objparams, nCoeff::Int64, nquad::Int64)
        N = params.N
        Ntot = N + params.Nguard
        K0,S0,K05,S05,K1,S1,vtargetr,vtargeti = KS_alloc(params)
        lambdar,lambdar0,lambdai,lambdai0,lambdar05,κ₁,κ₂,ℓ₁,ℓ₂,rhs,gr0,gi0,gr1,gi1,hr0,hi0,hi1,hr1,vr,vi,vi05,vr0,vfinalr,vfinali = time_step_alloc(Ntot,N)
        ...
        grad_f_his = zeros(nCoeff,nquad) # t included
        objfv_his = zeros(nquad)
        exp_v = zeros(nquad)  
        new(K0,S0,K05,S05,K1,S1,vtargetr,vtargeti,lambdar,lambdar0,lambdai,lambdai0,lambdar05,κ₁,κ₂,ℓ₁,ℓ₂,rhs,gr0,gi0,gr1,gi1,hr0,hi0,hi1,hr1,vr,vi,vi05,vr0,vfinalr,vfinali,gr, gi, gradobjfadj, tr_adj, grad_f_his, objfv_his, exp_v)
    end
